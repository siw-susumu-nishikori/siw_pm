...
public class KBTediDAO{
	 ...
	 private static final String SELECT_insymd = "select * from t_juchu where insymd=?";
	 private static final String SELECT_hinban = "select hinban from t_juchu group by hinban";
	 private static final String SELECT_day = "select insymd from t_juchu group by insymd";
	 private static final String SELECT_naiji_ins_day = "select insymd from t_juchu where naikaku_kb='3' group by insymd order by insymd desc limit 0,6"; //insymdを降順に6行分取得
	 private static final String SELECT_order = "SELECT * FROM("
	 											...
	 											+ "FROM t_juchu WHERE hinban= ? AND nounyushiji_ymd >= ? "
	 											+ "GROUP BY nounyushiji_ymd, noba_cd) AS X WHERE qty1 !=0 OR qty2 !=0 OR qty3 !=0 OR final_qty !=0 ";
	 private static final String INSERT_juchu = "insert into t_juchu values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
	 ...
	 private static final String INSERT_juchu2  = "insert into t_juchu values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
	 private static final String SELECT_sabun = "SELECT * FROM(SELECT nounyushiji_ymd, noba_cd, "
	 											...
	 											+ "FROM t_juchu WHERE hinban=? AND nounyushiji_ymd >=? AND naikaku_kb='3' GROUP BY nounyushiji_ymd, noba_cd) AS X WHERE qty1 !=0 OR qty2 !=0 ";
	 private static final String SELECT_tsuika_juchu ="SELECT * FROM t_juchu WHERE hinban=? AND nounyushiji_ymd>=? AND naikaku_kb='5' AND add_kb='1' ";
	 ...
	 private static final String SELECT_Kikan_Zaiko ="SELECT SUM(total_qty) AS Total_Qty FROM("
	 											+ "SELECT sum(juchu_su) AS total_qty FROM `t_juchu` "
	 ...
	 private static final String SELECT_sabunAll = "SELECT hinban, nounyushiji_ymd, noba_cd, "
												...
												+ "SUM(CASE WHEN insymd=? THEN juchu_su ELSE 0 END) AS qty2, "
												+ "(SUM(CASE WHEN insymd=? THEN juchu_su ELSE 0 END) - SUM(CASE WHEN insymd=? THEN juchu_su ELSE 0 END) ) AS su_sa  "
												+ "FROM t_juchu WHERE naikaku_kb='3' GROUP BY hinban,  nounyushiji_ymd, noba_cd";
	 ...
	 private static final String INSERT_kabusoku = "INSERT INTO kabusoku(hinban, mysry, kikansry, kabusoku)"
	 											...
	 											+ "SELECT hinban, juchu_su AS total_qty FROM `t_juchu` "
	 ...
	 private static final String SELECT_No_target = "SELECT hinban, SUM(juchu_su) AS gokei_su FROM t_juchu "
	 											+ "WHERE NOT EXISTS(SELECT 1 FROM tanpin_zaiko "
	 											+ "WHERE t_juchu.hinban=tanpin_zaiko.hinb) AND "
...
System.out.println(itemList);
	    ...
	    public void insertkb35juchu(int juchu_no, String naikaku_kb, String[] kensa_kb, String[] juchu_ymd, String[] insStartTime, String[] nounyushiji_ymd, String nounyushiji_time, String tok_cd, String chumon_no,
	    		String[] noba_cd, String[] kojo_cd, String[] hinban, String[] hin_nm, int[] juchu_su, String[] getsudo_kb, String[] kumitate_getsudo, int add_kb, String insymd, String instime/*, String[] S_time*/)
	    ...
	    public void insertNvan45(String kb_no, String kb_kojo, String kb_torihiki, String kb_chumon_no, String kb_hin_ku, String kb_hin_ban, String kb_ac, String kb_kakonai, String kb_hin_name,
	    					   ...
	    					   String kb_no_shiji_dt,	String kb_no_shiji_su, String kb_sei_kan_dt, String kb_hakko_dt, String kb_me_hin_no, String kb_shukka_kojo, String insertDay, String insertTime)
	    ...
	    public void insertNvan47(String kb_no, String kb_kojo, String kb_torihiki, String kb_chumon_no, String kb_hin_ku, String kb_hin_ban, String kb_ac, String kb_kako, String kb_hachu_tnk47, String kb_hachu_su47,
	    						 ...
	    						 String kb_shukka_kojo, String kb_me_hin_no, String kb_hakoshu, String kb_shuyo_su, String insertDay, String insertTime)
	    ...
	    public void insertKakutei(int juchu_no, String naikaku_kb, String[] kensa_kb, String[] juchu_ymd, String[] insStartTime, String[] nounyushiji_ymd, String nounyushiji_time, String tok_cd, String[] chumon_no,
	    		String[] noba_cd, String[] kojo_cd, String[] hinban, String[] hin_nm, int[] juchu_su, String[] getsudo_kb, String[] kumitate_getsudo, String[] seiban, String insymd, String instime,String[]rec_no)
